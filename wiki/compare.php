...
class compare
{
	...
	*/
	...
	public function compare_versions($article, $from, $to)
	{
		...
		$sql = 'SELECT article_text, bbcode_uid, bbcode_bitfield, article_sources, article_description, article_approved
		...
		$this->template->assign_vars(array(
			...
			'APPROVE_VERSION_FROM'	=> sprintf($this->user->lang('APPROVE_VERSION'), $from),
